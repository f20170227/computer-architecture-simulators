...
#define SN1 0 // predict NT, strong not taken
#define SN2 1 // predict NT, strong not taken
#define WN1 2 // predict NT, weak not taken
#define WN2 3 // predict NT, weak not taken
#define WT2 4 // predict T, weak taken
#define WT1 5 // predict T, weak taken
#define ST2 6 // predict T, strong taken
#define ST1 7 // predict T, strong taken
